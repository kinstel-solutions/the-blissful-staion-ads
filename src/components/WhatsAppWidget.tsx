...
export function WhatsAppWidget() {
  ...
  return (
    ...
    >
      <svg
        className="w-[30px] h-[30px] fill-current text-white transition-transform group-hover:rotate-12"
        viewBox="0 0 24 24"
      ...
      <span className="absolute left-full ml-3 px-3 py-1 bg-white text-gray-800 text-sm font-medium rounded-lg opacity-0 pointer-events-none transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 -translate-x-4 shadow-sm whitespace-nowrap border border-gray-100">
        Chat with us
      </span>
      <div className="absolute inset-0 rounded-full bg-[#25d366] animate-ping opacity-25 -z-10"></div>
    </a>
  );
}
