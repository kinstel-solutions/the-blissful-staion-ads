  ...
  return (
    <footer className="py-16 text-center border-t border-[#eee] text-[var(--text-light)] relative z-10 bg-[var(--bg-color)]">
        <div className="container mx-auto px-8 max-w-[1200px]">
            <p className="mb-2">
              <a href="tel:+919793743769" onClick={() => sendGAEvent({ event: 'generate_lead', lead_type: 'phone_call' })} className="hover:text-[var(--primary)] transition-colors">97937 43769</a> | contact.tbfst@gmail.com
            </p>
